...
This document describes how you can contribute to XGram Desktop.
...
We highly appreciate your contributions in the matter of fixing bugs and optimizing the XGram Desktop source code and its documentation. In case of fixing the existing user experience please push to your fork and [submit a pull request][pr].
...
We want to improve XGram Desktop with your contributions. But we also want to provide a stable experience for our users and the community. Follow these rules and you should succeed without a problem!
...
[translate]: ../Telegram/Resources/langs/lang.strings
[android_repo]: https://telegram.org/apps
